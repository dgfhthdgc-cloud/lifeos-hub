...
import { Target, Award, Flame, Zap, Shield, Sparkles, Swords } from 'lucide-react';
...
export function GamificationView() {
  ...
  const handleClaimQuest = (questId: string) => {
    ...
    if (result.xpAwarded > 0 && result.quest) {
      addXp(result.xpAwarded, `Claimed Quest: ${result.quest.title}`, 'quest');
      showToast({
